...
brfss_data %>% 
  ...
  ggplot(aes(x = response, y = data_value)) + geom_boxplot(aes(color = response)) + facet_grid(~year) + ggtitle("Figure 3. Distribution of data value responses among locations in New York State, 2006 and 2010") + theme(plot.title = element_text(hjust = 0.5)) + ylab("Data Value") +
  xlab("Response") +
  labs(color = "")
```
