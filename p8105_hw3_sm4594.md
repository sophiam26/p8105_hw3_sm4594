...
`product_name` and `aisle`, which is the name of the product ordered and
aisle from which it is ordered, respectively. For example, the mean
...
which the “poor” and “fair” responses have the lowest average data
value.
