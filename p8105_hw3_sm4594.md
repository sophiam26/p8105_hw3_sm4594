...
the “\`r names(which.max(table(pull(instacart, aisle))))” aisle.
...
As we can see in Figure 3, the response with the hightest data value in
2006 was “very good”, while the response “good” had the widest
distribution. In 2010, the response “very good” had both the highest
data value and widest distribution.
...
is a unique identifier for each day durng which data was collected,
...
Table 4. Total Activity by Day and
Week
...
weekdays there is more acitivty at night.
